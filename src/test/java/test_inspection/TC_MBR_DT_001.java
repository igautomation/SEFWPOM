...
public class TC_MBR_DT_001 {
	...
	@Test
	public void TC_MBR_DT_01(String Test_Data_Path, String Environment) throws Exception {
		...
		for (int i = 1; i <= NoOf_Itration; i++) {
			...
			if (map_Inspection_DubaiTrade.get("TestCaseNo").equals("TC_MBR_DT_001")) {
				...
				test = reports.createTest(map_Inspection_DubaiTrade.get("TestCaseDescription"));
				 ...
				 if ( Planner_User.equals(map_Environment_Details.get("Planner_UserID"))) {
					...
					Booking_Request_Sub_Status = DB_Connections.Booking_Request_Sub_Status(BookingRefNo, Environment);
					 ...
					 if (Booking_Request_Status.equals("05") && Booking_Request_Sub_Status.equals("04")) {
						 test.log(Status.PASS, "Request assigned to : " + Booking_Request_Status);
					 }
					 else {
						test.log(Status.FAIL, "Request is not yet assigned to : " + Booking_Request_Status);
						reports.flush();
						driver.quit();
						continue;
					 }					
					...
					if (map_Inspection_DubaiTrade.get("Sieze_Flag").equals("OFF")) {
					  ...
					  reports,i,Test_Data_Path,"Inspection_DubaiTrade" , BookingRefNo , Environment );
				...
				for(int l=1;l<=10;l++) {
				 ...
				 if (Booking_Request_Status.equals("11") && Booking_Request_Sub_Status.equals("12")) {
					 ...
					 test.log(Status.PASS, "Booking_Request_Sub_Status: " + Booking_Request_Status);
					 reports.flush();
						driver.quit();
					 break;
				 }
