...
public class Initiate_Inspection_CDM {
    ...
    public String Fn_Initiate_Inspection_CDM(WebDriver driver, ExtentTest test, String Environment,
        ...
        try {
            ...
            if (map_Login_Details.get("Environment").equals("SIT2")) {
                ...
                Result = Element.Click_Event(driver, test, reports, "//span[contains(text(), 'Initiate Inspection')]",
                        "Click Track-Inspection");
                // Thread.sleep(3000);
            }
            if (map_Login_Details.get("Environment").equals("SIT2")) {
            ...
            for (String Dec_No : numbers) {
                ...
                Result = Element.Click_Event(driver, test, reports, "//*[@aria-label='CDM Declaration Details:New']", "Add declaration Button");
                //Enter Declaration
                Result = Element.TextBox_Value(driver, test, reports, "//*[@id='1_DC_INS_Declaration_Number']", "Enter Declaration", Dec_No);
                //Save button
                Result = Element.Click_Event(driver, test, reports, "//*[@aria-label='CDM Declaration Details:Save']", "Save button");
                //Validate Inspection
                Result = Element.Click_Event(driver, test, reports, "//*[@aria-label='CDM Declaration Details:Validate']", "Validate Inspection");
                Thread.sleep(5000);
                if (map_Inspection_DubaiTrade.get("Multiple_Declaration_Flag").equalsIgnoreCase("ON")) {
                    ...
                    Result = Element.Click_Event(driver, test, reports, "//input[@id='1_DC_Multiple_Declaration_Flag']",
                            "Multiple Declaration Flag CheckBox");
                    // Save Record button
                    Result = Element.Click_Event(driver, test, reports, "//*[@id='s_1_1_28_0_Ctrl']", "Save Record button");
            ...
            //search Button
            Result = Element.Click_Event(driver, test, reports,
                    "//*[@aria-label='CDM Declaration Details:Query']", "search Button");
            //Go Button
            Result = Element.Click_Event(driver, test, reports,
                    "//*[@aria-label='CDM Declaration Details:Go']", "Go Button");
            // Initiate Inspection button
            Result = Element.Click_Event(driver, test, reports,
                    "//*[@aria-label='CDM Declaration Details:Initiate Inspection']", "Initiate Inspection button");
            // Inspection centre
            // Element.TextBox_Value(driver, "", Inspection_Centre);
            if (map_Inspection_DubaiTrade.get("Multiple_Declaration_Flag").equalsIgnoreCase("ON")) {
                // Inspection centre
                Element.TextBox_Value(driver, test, reports, "//input[@aria-labelledby='DCINSInspectionCentre_Label']",
                        "Inspection centre", map_Inspection_DubaiTrade.get("Inspection_Centre"));
                // Inspection section
                Result = Element.TextBox_Value(driver, test, reports, "//input[@name='s_3_1_21_0']",
                        "Inspection section", map_Inspection_DubaiTrade.get("Inspection_Section"));
                // Contact Email
                ...
                // Representative Name
                Result = Element.TextBox_Value(driver, test, reports, "//input[@name='s_3_1_27_0']",
                        "Representative Name", map_Inspection_DubaiTrade.get("Representative_Name"));
                // Contact Number
                ...
                if (map_Inspection_DubaiTrade.get("Seal_Flag").equals("ON")) {
                    // Seal Flag
                    Result = Element.Check_Box(driver, test, reports, "//input[@aria-label='Seal Required']",
                            "Seal Flag", "ON");
                    // Seal Quantity
                    Result = Element.Click_Event(driver, test, reports, "//*[@aria-labelledby='DCINSStatus_Label']",
                            "Seal Status");
                    // Seal Quantity
                    Result = Element.TextBox_Value(driver, test, reports,
                            "//input[@aria-labelledby='DCINSNoofSealsRequired_Label']", "Seal Quantity",
                ...
                if (map_Inspection_DubaiTrade.get("Auto_FollowUp").equals("ON")) {
                    // Follow Up Flag
                    Result = Element.Check_Box(driver, test, reports, "//input[@aria-label='Follow Up Required']",
                            "Auto Follow Up Flag", "ON");
                    // Request Status
                    Result = Element.Click_Event(driver, test, reports, "//*[@aria-labelledby='DCINSStatus_Label']",
                            "Request Status");
                    // Inspection centre
                    Result = Element.TextBox_Value(driver, test, reports,
                            "//input[@aria-labelledby='DC_INS_Followup_Centre_Label']", "Inspection centre",
                            map_Inspection_DubaiTrade.get("Inspection_Centre"));
                    // Inspection section
                    Result = Element.TextBox_Value(driver, test, reports,
                            "//input[@aria-labelledby='DC_INS_Followup_Section_Label']", "Inspection section",
                ...
                Result = Element.TextBox_Value(driver, test, reports, "//input[@name='s_3_1_0_0']",
                        "Additional preferred Slot text box",
                        map_Inspection_DubaiTrade.get("Additional_Preferred_Slot"));
                Thread.sleep(2000);
                // Record Save Button
                Result = Element.Click_Event(driver, test, reports, "//button[@id='s_3_1_49_0_Ctrl']",
                        "Record Save Button");
                // Next Button
                Result = Element.Click_Event(driver, test, reports, "//*[@id='s_3_1_32_0_Ctrl']", "Next Button");
                // Seal Flag
                if (map_Inspection_DubaiTrade.get("Seal_Flag").equals("ON")) {
                    // Next button
                    Result = Element.Click_Event(driver, test, reports, "//*[@id='s_2_1_30_0_Ctrl']", "Next Button");
                    ...
                    Thread.sleep(2000);
                    // Submit button
                    Result = Element.Click_Event(driver, test, reports, "//*[@id='s_1_1_31_0_Ctrl']", "Submit Button");

                }
            } else {
                // Inspection centre
                Result = Element.TextBox_Value(driver, test, reports, "//input[@aria-label='Inspection Centre']",
                        "Inspection centre", map_Inspection_DubaiTrade.get("Inspection_Centre"));
                // Inspection section
                Result = Element.TextBox_Value(driver, test, reports, "//input[@name='s_2_1_20_0']",
                        "Inspection section", map_Inspection_DubaiTrade.get("Inspection_Section"));
                // Contact Email
                Result = Element.TextBox_Value(driver, test, reports, "//input[@name='s_2_1_14_0']", "Contact Email",
                        map_Inspection_DubaiTrade.get("Contact_Email"));
                // Representative Name
                Result = Element.TextBox_Value(driver, test, reports, "//input[@name='s_2_1_27_0']",
                        "Representative Name", map_Inspection_DubaiTrade.get("Representative_Name"));
                // Contact Number
                ...
                Result = Element.Click_Event(driver, test, reports, "//button[@id='s_3_1_33_0_Ctrl']",
                        "Group Dates OK Button");
                // Record Save Button
                Result = Element.Click_Event(driver, test, reports, "//button[@id='s_1_1_16_0_Ctrl']",
                        "Record Save Button");
                // Next Button
                Result = Element.Click_Event(driver, test, reports, "//*[@id='s_2_1_31_0_Ctrl']", "Next Button");
                if (driver.findElements(By.xpath("//*[@aria-label='Message:Ok']")).size() != 0) {
                    // Ok Button
                    Result = Element.Click_Event(driver, test, reports, "//*[@aria-label='Message:Ok']", "Ok Button");
                ...
                if (map_Inspection_DubaiTrade.get("Seal_Flag").equals("ON")) {
                    if (map_Inspection_DubaiTrade.get("Payment_Mode").equals("Credit Account")) {
                        ...
                        Result = Element.Click_Event(driver, test, reports,
                                "//td[@id='1_s_3_l_DC_INS_Transaction_Type']", "Activate Credit Account element");
                        // Credit Account No Selection
                        Result = Element.TextBox_Value(driver, test, reports,
                                "//input[@id='1_DC_INS_Transaction_Type']", "Credit Account No Selection",
                                map_Inspection_DubaiTrade.get("Credit_Account"));
                        // Record Save Button
                        Result = Element.Click_Event(driver, test, reports, "//button[@id='s_3_1_19_0_Ctrl']",
                                "Record Save Button");

                    } else if (map_Inspection_DubaiTrade.get("Payment_Mode").equals("Cash")) {
                    } else if (map_Inspection_DubaiTrade.get("Payment_Mode").equals("ePay")) {
                    }
                    // Make Payment
                    Result = Element.Click_Event(driver, test, reports, "//button[@id='s_3_1_12_0_Ctrl']",
                            "Make Payment");
                    // Payment Success
                    Result = Element.Text_Present(driver, test, reports, "//td[@title='Authorized']",
                            "Payment Success");
                    // Record Save Button
                    Result = Element.Click_Event(driver, test, reports, "//button[@id='s_3_1_19_0_Ctrl']",
                            "Record Save Button");
