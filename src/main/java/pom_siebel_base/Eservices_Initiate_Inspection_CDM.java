...
public class Eservices_Initiate_Inspection_CDM {
    ...
    public String EService_CDM(WebDriver driver, ExtentTest test, ExtentReports reports, int j, String Test_Data_Path, String Sheet, String Environment) throws Exception {
        this.driver = driver;
        this.test = test;
        ...
        try {
            if (map_Inspection.get("Multiple_Declaration_Flag").equals("ON")) {
                ...
                Thread.sleep(5000);
                Result = "Pass";
                test.log(Status.INFO, "Initiate Booking Request CDM is submitted Successfully");
                reports.flush();
                driver.quit();
            } else {
                //Create Inspection Requests
            ...
            Result = "Fail";
            test.log(Status.FAIL, "EService_Booking Request function CDM Failed");
            reports.flush();
            driver.quit();
