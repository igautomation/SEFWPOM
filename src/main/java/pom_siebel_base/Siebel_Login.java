...
public class Siebel_Login {
    ...
    public String Siebel_Login_Function(WebDriver driver, ExtentTest test, ExtentReports reports, String Environment, String Test_Data_Path, String Scenario) throws InterruptedException, IOException {
        this.driver = driver;
        this.test = test;
        ...
        try {
            ...
            } else if (Scenario.equals("Planner")) {
                Result = Element.TextBox_Value(driver, test, reports, "//*[@id='s_swepi_1']", "Login ID", map.get("Planner_UserID"));
                // Password Filed
                Result = Element.TextBox_Value(driver, test, reports, "//*[@id='s_swepi_2']", "Password", map.get("Planner_Password"));
                //Login Button
            ...
            } else if (Scenario.equals("Inspector")) {
                Result = Element.TextBox_Value(driver, test, reports, "//*[@id='s_swepi_1']", "Login ID", map.get("Inspector_UserID"));
                // Password Filed
                Result = Element.TextBox_Value(driver, test, reports, "//*[@id='s_swepi_2']", "Password", map.get("Inspector_Password"));
                //Login Button
            ...
            } else if (Scenario.equals("VC_Entry")) {
                Result = Element.TextBox_Value(driver, test, reports, "//*[@id='s_swepi_1']", "Login ID", map.get("VC_Entry_Inspector_UserID"));
                // Password Filed
                Result = Element.TextBox_Value(driver, test, reports, "//*[@id='s_swepi_2']", "Password", map.get("VC_Entry_Inspector_Password"));
                //Login Button
            ...
            } else if (Scenario.equals("VC_Exit")) {
                Result = Element.TextBox_Value(driver, test, reports, "//*[@id='s_swepi_1']", "Login ID", map.get("VC_Exit_Inspector_UserID"));
                // Password Filed
                Result = Element.TextBox_Value(driver, test, reports, "//*[@id='s_swepi_2']", "Password", map.get("VC_Exit_Inspector_Password"));
                //Login Button
            ...
            if (driver.findElements(By.xpath("/html/body/div[1]/div/div[3]/div/span/span/ul/li/span")).size() != 0) {
                Result = "Pass";
            } else if (driver.findElements(By.xpath("//*[@id='s_1_l_salutation']/span[2]/div[1]/label")).size() != 0) {
                Result = "Pass";
            } else if (driver.findElements(By.xpath("//*[@id='siebui-threadbar']/li/span")).size() != 0) {
                Result = "Pass";
            } else if (driver.findElements(By.xpath("//a[normalize-space()='Assigned Requests']")).size() != 0) {
                Result = "Pass";
            } else {
                Result = "Fail";
            }
